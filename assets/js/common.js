$(function () {
    ...
    $('.index__open_btn').on('click', function () {
        $('.index').addClass('open_index');
        $('.index__open_btn').addClass('visible_btn');
    });
    $('.index__close_btn').on('click', function () {
        $('.index').removeClass('open_index');
        $('.index__open_btn').removeClass('visible_btn');
    });
