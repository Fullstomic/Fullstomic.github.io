import { toRef, onScopeDispose, ref, watch, nextTick, mergeProps, createVNode, toValue, computed, createElementVNode, Fragment, Teleport, withDirectives, vShow, shallowRef, inject, reactive, provide, toRaw, watchEffect, readonly, Transition } from 'vue';
import { f as forwardRefs, q as animate, B as Box, r as getTargetBox, s as getElementBox, t as getOverflow, v as nullifyTransforms } from './VTextField-Bxj5HX4m.mjs';
import { j as VDefaultsProvider, o as useBackgroundColor, u as useDimension, y as useRouter, k as makeDimensionProps, A as parseAnchor, B as flipSide, C as flipAlign, D as flipCorner, i as deepEqual, E as getAxis } from './VRow-DYQSMIMZ.mjs';
import { q as propsFactory, G as getCurrentInstance, g as genericComponent, d as useProxiedModel, m as useRender, C as focusableChildren, p as provideTheme, h as useRtl, H as useToggleScope, J as convertToUnit, y as omit, a5 as templateRef, s as makeThemeProps, t as makeComponentProps, a4 as defer, x as matchesSelector, $ as acceleratedEasing, a1 as standardEasing, a0 as deceleratedEasing, a2 as destructComputed, a3 as CircularBuffer, O as consoleError, D as clamp } from './server.mjs';
import { M as MaybeTransition, m as makeTransitionProps } from './VAvatar-CVUX6xse.mjs';
...
export { VDialog as V, VMenuSymbol as a, VOverlay as b, VDialogTransition as c, makeFocusTrapProps as d, makeDelayProps as e, useFocusTrap as f, useDelay as g, makeVOverlayProps as m, useScopeId as u };
//# sourceMappingURL=VDialog-DisBU3DD.mjs.map
