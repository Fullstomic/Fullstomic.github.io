import { toRef, shallowRef, ref, createVNode, normalizeStyle, normalizeClass, computed, watch, withDirectives, mergeProps, createElementVNode, Fragment, toDisplayString, toRaw, toValue, provide, inject, nextTick, watchEffect, vShow } from 'vue';
import { o as VExpandTransition } from './VTextField-Bxj5HX4m.mjs';
import { g as genericComponent, p as provideTheme, j as provideDefaults, m as useRender, J as convertToUnit, Q as deprecate, d as useProxiedModel, G as getCurrentInstance, A as focusChild, q as propsFactory, I as IconValue, s as makeThemeProps, t as makeComponentProps, R as EventProp, S as isPrimitive, O as consoleError, T as pick, E as getPropertyFromItem, y as omit, w as wrapInArray, P as defineComponent } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-ZQn7gOuX.mjs';
import { o as useBackgroundColor, p as useBorder, l as useDensity, u as useDimension, q as useElevation, r as useRounded, R as Ripple, s as useLink, t as useVariant, v as genOverlays, b as VIcon, j as VDefaultsProvider, n as useTextColor, m as makeVariantProps, c as makeTagProps, e as makeRoundedProps, f as makeElevationProps, k as makeDimensionProps, g as makeDensityProps, h as makeBorderProps, w as makeRouterProps, i as deepEqual } from './VRow-DYQSMIMZ.mjs';
import { V as VAvatar, c as createSimpleFunctional, M as MaybeTransition } from './VAvatar-CVUX6xse.mjs';
...
export { VList as V, VListItem as a, VDivider as b, VListSubheader as c, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-DE8QLq0V.mjs.map
