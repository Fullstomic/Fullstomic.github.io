import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance as getCurrentInstance$1, watch, onScopeDispose, camelize, isVNode, Comment, Fragment, warn, inject as inject$1, toRef, useId, provide, shallowRef, computed, reactive, watchEffect, toValue, capitalize, ref, toRaw, defineComponent as defineComponent$1, unref, readonly, effectScope, hasInjectionContext, createVNode, mergeProps, createElementVNode, normalizeClass, defineAsyncComponent, h, shallowReactive, normalizeStyle, useSSRContext, createApp, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, Suspense, nextTick, getCurrentScope, isReadonly, isRef, isShallow, isReactive, toRefs } from 'vue';
import { p as parseURL, l as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, k as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as createHooks, h as createError$1, x as defu, y as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BLEnigco.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-B8yBPo11.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./index-DiCHt0Xs.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./index-CjrFDb59.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./index-CFSzi1ry.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-8sm_05e1.mjs')
  },
  {
    name: "contact-complete",
    path: "/contact/complete",
    component: () => import('./complete-D8NyZKwn.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BZK5mfuc.mjs').then((m) => m.default || m))
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VApp, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(VApp)
            ];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-rLg_9ArV.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C1XhQsvG.mjs'));
...
export { acceleratedEasing as $, focusChild as A, getNextElement as B, focusableChildren as C, clamp as D, getPropertyFromItem as E, debounce as F, getCurrentInstance as G, useToggleScope as H, IconValue as I, convertToUnit as J, camelizeProps as K, ensureValidVNode as L, checkPrintable as M, callEvent as N, consoleError as O, defineComponent as P, deprecate as Q, EventProp as R, isPrimitive as S, pick as T, useGoTo as U, makeDisplayProps as V, PageRouteSymbol as W, LayoutMetaSymbol as X, useLayoutItem as Y, makeLayoutItemProps as Z, VApp as _, useNuxtApp as a, deceleratedEasing as a0, standardEasing as a1, destructComputed as a2, CircularBuffer as a3, defer as a4, templateRef as a5, PREFERS_REDUCED_MOTION as a6, getCurrentInstanceName as a7, isObject as a8, onlyDefinedProps as a9, findChildrenWithProvide as aa, consoleWarn as ab, includes as ac, isCssColor as ad, isParsableColor as ae, parseColor as af, getForeground as ag, useTheme as ah, useIcon as ai, flattenFragments as aj, hasEvent as ak, breakpoints as al, useRuntimeConfig as b, nuxtLinkDefaults as c, useProxiedModel as d, entry_default as default, encodeRoutePath as e, useLocale as f, genericComponent as g, useRtl as h, useDisplay as i, provideDefaults as j, useResizeObserver as k, createRange as l, useRender as m, navigateTo as n, keyValues as o, provideTheme as p, propsFactory as q, resolveRouteObject as r, makeThemeProps as s, makeComponentProps as t, useRouter as u, filterInputAttrs as v, wrapInArray as w, matchesSelector as x, omit as y, isClickInsideElement as z };
